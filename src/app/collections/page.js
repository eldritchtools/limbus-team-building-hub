...
export default function CollectionsPage() {
        ...
        const fetchLists = async () => {
            try {
                ...
                const data = activeTab === "popular" ?
                    await searchCollections({}, true, "popular", 1, 10) :
                    activeTab === "recent" ?
    ...
    return <div style={{ display: "flex", flexDirection: "column", textAlign: "center", gap: "0.5rem" }}>
        <div>
            Collections are lists of content managed by users. Some collections may be open to contributions from other users.
        </div>
